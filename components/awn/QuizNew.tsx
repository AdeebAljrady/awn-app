...
import { generateQuizFromPDF } from "@/app/actions/AI/geminiService";
...
const QUIZ_LOADING_MESSAGES = [
  "جاري قراءة الملف وتحليل بياناته...",
  ...
  if (step === "LOADING") {
    return (
      <Loading
        ...
        subMessage={unitPreference ? `نختبرك الآن في "${unitPreference}"` : "سوف نقوم بإنشاء اختبار شامل لك بكامل الملف"}
        fullScreen
      />
    );
  }
